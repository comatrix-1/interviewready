...
>>>>>>> d4ad3a3680180078956713f7cb95169837622063
            ...
            score_100 = self._calculate_confidence(structured_result)
            confidence_score = round(score_100 / 100.0, 4)
            structured_result["score"] = score_100
            decision_trace = [
                "ResumeCriticAgent: Analyzed resume structure and content impact",
                f"ResumeCriticAgent: Generated critique with confidence {confidence_score}",
            ]
            sharp_metadata = {
