...
def test_interview_coach_advances_on_valid_answers_until_summary(monkeypatch) -> None:
    ...
    final_payload = final_response.content
...
def test_interview_coach_handles_invalid_then_valid_and_reaches_summary(
    ...
    opening_payload = opening_response.content
    ...
    invalid_payload = invalid_response.content
    ...
    summary_payload = summary_response.content
...
def test_interview_coach_generates_summary_after_five_sequential_valid_answers(
    ...
    assert opening_response.content["current_question_number"] == 1
