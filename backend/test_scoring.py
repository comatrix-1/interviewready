...
def test_scoring_system():
    ...
    for answer, _description in test_cases:
        score, feedback, _meets_minimum = agent._score_interview_answer(answer, "Test question", context)

    # Test comprehensive validation
    for answer, _description in test_cases[:3]:  # Skip the obviously bad ones
        _can_proceed, _feedback, _score = agent._comprehensive_validate_answer(answer, "Test question", context, False)
